          ...
          <div className="lg:col-span-1 bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            ...
            <form onSubmit={handleCreateContract} className="space-y-4">
              ...
              <div>
                ...
                <input required type="text" value={payeeAccountNumber} onChange={e => setPayeeAccountNumber(e.target.value)} className="w-full border border-slate-300 rounded-md px-3 py-2 focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. 1234567890" />
              </div>
              <div>
